...
private:
  ...
  */
  ...
  /*
    ...
    to refresh the current-relay-log vs until-log comparison result.
    And it is checked to decide whether it's a right time to do so
    which is when the being processed group has been fully scheduled.
  */
