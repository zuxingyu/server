	...
	mtr_t*		mtr)
{
	...
	{
		mem_heap_t*	heap		= NULL;
		rem0offset_t	cur_offs_[REC_OFFS_NORMAL_SIZE];
		rem0offset_t	ins_offs_[REC_OFFS_NORMAL_SIZE];

		rem0offset_t*	cur_offs;
		rem0offset_t*	ins_offs;
...
/*====================*/
	...
	rem0offset_t*	offsets,/*!< in/out: rec_get_offsets(rec, index) */
	mtr_t*		mtr)	/*!< in: mini-transaction handle, or NULL */
{
	...
	if (UNIV_LIKELY_NULL(free_rec)) {
		...
		rem0offset_t	foffsets_[REC_OFFS_NORMAL_SIZE];
		rem0offset_t*	foffsets	= foffsets_;
		mem_heap_t*	heap		= NULL;
