...
/*===========*/
	...
	const rem0offset_t*	offsets)/*!< in: record descriptor */
{
				...
				the page record type definition */
{
	...
	rem0offset_t*		offsets		= offsets_1;
	rem0offset_t*		old_offsets	= offsets_2;
...
/*============*/
	...
	const rem0offset_t*		offsets)/*!< in: offsets for record */
{
