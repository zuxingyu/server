...
/*==============================*/
	rem0offset_t*	offsets,/*!< in: work area for the return value */
...
/*=================*/
	...
	rem0offset_t**	offsets,/*!< in: rec_get_offsets(
...
/*===================*/
	...
	rem0offset_t**	offsets,/*!< in/out: temporary storage */
...
/*================*/
	...
	rem0offset_t**	offsets,/*!< in/out: buffer for rec_get_offsets() */
	mtr_t*		mtr)	/*!< in: mtr */
{
	const page_t*	page	= buf_block_get_frame(block);
	page_cur_t	cursor;
