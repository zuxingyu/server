	...
	que_thr_t*	thr)
{
	...
	rem0offset_t	clust_offsets_[REC_OFFS_NORMAL_SIZE];
	rem0offset_t	sec_offsets_[REC_OFFS_SMALL_SIZE];
	rem0offset_t*	clust_offs	= clust_offsets_;
	rem0offset_t*	sec_offs	= sec_offsets_;
	ibool		is_equal	= TRUE;
...
/*====================*/
	...
	rem0offset_t**	offsets,	/*!< in/out: offsets returned by
	...
	mtr_t*			mtr)	/*!< in: mtr */
{
	...
	rem0offset_t	offsets_[REC_OFFS_NORMAL_SIZE];
	rem0offset_t*	my_offsets = const_cast<rem0offset_t*>(offsets);
...
/*=============================*/
	...
	const rem0offset_t*		offsets)	/*!< in: rec_get_offsets
						(index_rec, index) */
{
	const byte*	data;
	ulint		len;
...
public:
	...
	dberr_t operator()(row_prebuilt_t *prebuilt, dict_index_t *sec_index,
			...
			rem0offset_t **offsets, mem_heap_t **offset_heap,
...
/*============================*/
	...
	const rec_t**	out_rec,/*!< out: clustered record or an old version of
				...
				in the read view, i.e., it was a fresh
				inserted version */
	rem0offset_t**	offsets,/*!< in: offsets returned by
...
/*==================================*/
	...
	row_prebuilt_t*	prebuilt,/*!< in: prebuilt struct */
	rem0offset_t**	offsets,/*!< in/out: for rec_get_offsets(*out_rec) */
