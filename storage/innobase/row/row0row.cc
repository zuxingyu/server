	...
	mem_heap_t*		heap)
{
	...
	rec_offs_make_valid(copy, index, const_cast<rem0offset_t*>(offsets));
	...
	rec_offs_make_valid(rec, index, const_cast<rem0offset_t*>(offsets));
					...
					the memory needed is allocated */
{
	...
	rec_offs_make_valid(copy_rec, index, const_cast<rem0offset_t*>(offsets));
...
/*=======================*/
	...
	rem0offset_t*		offsets,/*!< in: rec_get_offsets(rec, index)
					or NULL */
