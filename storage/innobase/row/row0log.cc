...
/*=============================*/
	...
	const rem0offset_t*		offsets,	/*!< in: offsets of mrec */
...
/*===========================*/
	btr_pcur_t*		pcur,		/*!< in/out: B-tree cursor,
						will be trashed */
	const rem0offset_t*		offsets,	/*!< in: offsets on pcur */
	mem_heap_t*		heap,		/*!< in/out: memory heap */
...
/*=======================*/
	ulint			trx_id_col,	/*!< in: position of
						...
						clustered index */
	const mrec_t*		mrec,		/*!< in: merge record */
	const rem0offset_t*		moffsets,	/*!< in: offsets of mrec */
	mem_heap_t*		offsets_heap,	/*!< in/out: memory heap
						that can be emptied */
	mem_heap_t*		heap,		/*!< in/out: memory heap */
...
func_exit_committed:
	...
	rem0offset_t*		cur_offsets	= rec_get_offsets(
...
/*===================*/
	...
	rem0offset_t*		offsets)	/*!< in/out: work area
						for parsing mrec */
{
	...
	ut_stage_alter_t*	stage)
{
	...
	offsets = static_cast<rem0offset_t*>(ut_malloc_nokey(i * sizeof *offsets));
...
/*=============*/
	...
	const mrec_t*	mrec,		/*!< in: merge record */
	const mrec_t*	mrec_end,	/*!< in: end of buffer */
	rem0offset_t*	offsets)	/*!< in/out: work area for
