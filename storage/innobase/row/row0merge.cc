...
/*==================*/
	...
	rem0offset_t**		offsets1,	/*!< out: offsets */
	rem0offset_t**		offsets2)	/*!< out: offsets */
{
	...
	*offsets1 = static_cast<rem0offset_t*>(
		mem_heap_alloc(heap, i * sizeof **offsets1));
	*offsets2 = static_cast<rem0offset_t*>(
...
/*===============*/
	...
	rem0offset_t*		offsets,/*!< out: offsets of mrec */
	row_merge_block_t*	crypt_block, /*!< in: crypt buf or NULL */
	ulint			space) /*!< in: space id */
{
	ulint	extra_size;
	...
	ulint			space)
{
	...
	rem0offset_t*	offsets0;/* offsets of mrec0 */
	rem0offset_t*	offsets1;/* offsets of mrec1 */
	...
	ulint			space)
{
	...
	rem0offset_t*	offsets0;/* offsets of mrec0 */
	rem0offset_t*	offsets1;/* dummy offsets */
