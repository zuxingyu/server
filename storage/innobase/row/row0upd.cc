...
/*=================================*/
	...
	rem0offset_t*	offsets,/*!< in/out: rec_get_offsets(pcur.rec, index) */
...
#ifdef UNIV_DEBUG
	const rem0offset_t*	offsets,/*!< in: rec_get_offsets(rec), or NULL */
#endif /* UNIV_DEBUG */
...
/*==============*/
	...
	upd_node_t*	node,	/*!< in: row update node */
	dict_index_t*	index,	/*!< in: clustered index */
	rem0offset_t*	offsets,/*!< in: rec_get_offsets() on node->pcur */
...
/*=======================*/
	upd_node_t*	node,	/*!< in: row update node */
	dict_index_t*	index,	/*!< in: clustered index */
	rem0offset_t*	offsets,/*!< in/out: rec_get_offsets() for the
