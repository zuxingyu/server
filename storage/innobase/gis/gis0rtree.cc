...
/*============================*/
	...
	rem0offset_t**	offsets,/*!< in: offsets on inserted record */
...
/*==========================*/
	...
	rem0offset_t*	offsets,	/*!< in/out: offsets on rec. */
	...
	mtr_t*		mtr)		/*!< in: mtr */
{
	...
	if (rec_info & REC_INFO_MIN_REC_FLAG) {
		...
		page_cur_t		page_cur;
		rec_t*			insert_rec;
		rem0offset_t*		insert_offsets = NULL;
		ulint			old_pos;
		rec_t*			old_rec;
...
/*======================*/
	...
	btr_cur_t*	cursor,	/*!< in/out: cursor at which to insert; when the
				function returns, the cursor is positioned
				on the predecessor of the inserted record */
	rem0offset_t**	offsets,/*!< out: offsets on inserted record */
	...
	mtr_t*		mtr)		/*!< in: mtr */
{
	...
	page_cur_t	cur1;
	rec_t*		cur_rec;
	rem0offset_t	offsets_1[REC_OFFS_NORMAL_SIZE];
	rem0offset_t*	offsets1 = offsets_1;
	rem0offset_t	offsets_2[REC_OFFS_NORMAL_SIZE];
	rem0offset_t*	offsets2 = offsets_2;
	ulint		moved = 0;
...
/*==================*/
	...
	rem0offset_t*		offsets,	/*!< in: rec offsets */
	rem0offset_t*		offsets2,	/*!< in: rec offsets */
